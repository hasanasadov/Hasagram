  ...
  return (
    <div className="bg-white p-8 rounded-lg shadow-md max-w-md min-w-[400px]">
      ...
      <div className="flex items-center justify-between text-gray-500">
        ...
        <button onClick={toggleCollapse} className="flex justify-center items-center gap-2 px-2 hover:bg-gray-50 rounded-full p-1">
          <svg
            width="22px"
            height="22px"
            viewBox="0 0 24 24"
      ...
      <Collapsible open={!collapsed} onOpenChange={setCollapsed}>
        <CollapsibleContent>
          <PostComments isOpen={!collapsed} postId={id} comments={comments} />
        </CollapsibleContent>
      </Collapsible>
    </div>
  );
